...
「我被資遣了，可以領失業給付嗎？」「我自己離職也算失業嗎？」「失業給付到底領得到多少、多久？」每年景氣轉差、企業裁員潮一到，實習通後台這類問題就會爆增。剛畢業就遇到資遣的社會新鮮人尤其茫然——勞動法明明寫得清清楚楚，但 1955 客服電話打不通、勞工局網站訊息散落，學生根本拼不齊一張完整的圖。本篇把就業保險的整個邏輯講清楚：誰有資格、能領多久、怎麼申請、自願離職的人有沒有後路，以及最常被忽略的「**視為非自願離職**」這個救生圈。
...
| 提早就業獎助津貼 | 失業給付請領期間提前找到工作的獎勵 |
| 職業訓練生活津貼 | 參加全日制職訓期間的生活費補助 |
| 育嬰留職停薪津貼 | 育嬰假期間部分薪資補助 |
| 健保保費補助 | 失業期間及育嬰留停期間健保自付部分補助 |

對 22-30 歲的社會新鮮人來說，最常用到的是「**失業給付**」與「**提早就業獎助津貼**」。

## 二、失業給付的請領條件：三個門檻一個都不能少

很多學生以為「失業就能領」，這是天大的誤會。失業給付有 **三個並列必要條件**，缺一不可。

### 條件一：非自願離職
**這是最關鍵也最常卡關的條件**。所謂「非自願離職」，是指：
...
- 勞工依《勞動基準法》§14 各款主動終止契約（勞工依法主動離職並請求資遣費的情況），實務上多被視為「**非自願離職**」處理。

換句話說：**被資遣才能領，自己想換工作不能領**。

### 條件二：就業保險年資合計滿 1 年以上
- 年資是「合計」的，不是只看這一份工作。
- 退保前 3 年內就業保險年資合計滿 1 年即可。
- 即使中間換過公司、中斷過幾個月，只要累計達 1 年，就符合這項條件。

### 條件三：辦理失業認定 2 週仍未就業
- 離職後須親自到 **公立就業服務機構**（各縣市就業中心）辦理「**求職登記**」與「**失業認定**」。
- 在此期間就服站會推介至少 2 個工作機會。
- **如果 2 週內已重新就業，不能領**；2 週後仍未就業且配合就業諮詢者，才開始發給。

### 三條件的核對表
| 你符合哪些？ | 結果 |
|--------------|------|
| 非自願離職 + 年資 ≥ 1 年 + 已辦失業認定 | 可請領 |
| 自願離職 + 年資 ≥ 1 年 | 不可請領 |
| 非自願離職 + 年資 < 1 年 | 不可請領 |
| 非自願離職 + 年資 ≥ 1 年 + 1 週就找到工作 | 不可請領（已就業）|

## 三、能領多少？領多久？

### 1. 給付金額
失業給付按「**離職退保前 6 個月平均月投保薪資 × 60%**」發給。例如離職前平均投保薪資 30,300 元，每月可領 18,180 元。

### 2. 給付期間
- **一般受僱者**：最長 **6 個月**。
- **滿 45 歲以上或身心障礙者**：最長 **9 個月**。
- 給付期滿仍未就業的，原則上不能再領（除非又重新就業並累積新的年資、再次符合條件）。

### 3. 扶養親屬加給
被保險人有撫養共同生活之無工作收入配偶、未成年子女或身心障礙子女時，每多 1 人按給付月額之 **10%** 加給，最多計至 **20%**。
...
### 1. 領取條件
- 已申請失業給付，且尚有可請領期間（也就是還沒領完）。
- 在失業給付請領期滿前重新就業，且新工作須繼續加保就保滿 **3 個月以上**。

### 2. 給付金額
按「**尚未請領的失業給付金額之 50%**」一次發給。
...
### 2. 為什麼這條重要？
依《就業保險法》規定，勞工依《勞基法》§14 終止契約者，**視為非自願離職**，可請領失業給付。換句話說：
...
**Q1：我才剛畢業就被資遣，能不能領？**
要看年資。社會新鮮人若沒做滿 1 年就被資遣，原則上不符合「年資合計滿 1 年」的條件，無法領失業給付。但若先前在學期間有 part-time 並投過就保，年資是可以合計的。
...
**Q6：失業期間健保怎麼辦？**
失業給付請領期間，被保險人及隨同其加保眷屬之健保自付保費由就業保險基金補助。記得在認定時一併確認。

**Q7：我先生 / 太太是外籍人士，他失業也能領嗎？**
外籍配偶取得居留證並依法受僱投保就保者，**符合請領條件即可領**。實際以勞保局認定為準。

## 十、結語：被資遣不可怕，被「自願離職」誤導才可怕
...
4. **離職後第一週就到就服站**：不要拖，14 天等待期是從你登記那天開始算。
