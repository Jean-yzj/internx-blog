...
**勞動基準法強制規定**：勞基法是「最低勞動條件」的規範。基本工資、加班費、特休、職災補償等，**勞雇雙方不得以契約約定排除或低於法定標準**。違反者，該部分約定無效（依勞基法 §1）。
...
對一個月薪 28,590 元（2025 年基本工資）的實習生來說，500 萬違約金等於要他不吃不喝工作 14 年才能還清。**這顯然失衡**。
...
勞基法 §9-1 明定競業禁止五要件，**期間最長不得超過 2 年**。逾此期間者縮短為 2 年。

換句話說：寫 5 年、10 年、永久——**自動縮短為 2 年**，但前提是其他四要件都成立（正當營業利益、接觸營業秘密、合理範圍、合理補償）。**任一要件不成立，整條無效**。

詳細說明請參考本系列第二篇：《競業禁止條款：勞基法 §9-1 五要件全解析》。

### 修改建議

> 「依勞基法 §9-1，競業禁止期間不得超過 2 年。建議將第 X 條的期間調整為 6 個月至 1 年，並補上合理補償條款（離職前月薪 50% 以上）。」
...
> 「第 X 條的強制調動條款建議調整為『公司因業務需求調動員工，應符合勞基法 §10-1 規定之調動原則』，以維護雙方權益的平衡。」
